...
## 📞 The call
A recruiting agency (Interviewbit) contacted me for UI Engineer 1 opening in Flipkart and setup the onsite. (I should clarify something here - I am not recommending that you use Interviewbit platform or pay for their courses; I merely had a profile on their website, wasn't active in solving their questions, neither did i join their courses. Their main business is referring candidates and they get paid by Flipkart for successful candidates.) There was no screening round, it was directly onsite. About 10-12 candidates were invited for the same role, on a weekend.  
